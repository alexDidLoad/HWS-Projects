...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let optionAc = UIAlertController(title: "Delete or Rename", message: "What do you want to do?", preferredStyle: .alert)
        optionAc.addAction(UIAlertAction(title: "Delete", style: .destructive) { [weak self] _ in
            self?.people.remove(at: indexPath.item)
            self?.collectionView.deleteItems(at: [indexPath])
        })
        
        optionAc.addAction(UIAlertAction(title: "Rename", style: .default, handler: {
